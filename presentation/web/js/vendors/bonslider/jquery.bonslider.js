/*maqinato (www.https://github.com/maparrar/maqinato) - Bonslider v.0.3
 *Feb 2013
 *This plugin make a slider in the div
 **/
;(function($){
    //Inicializa cada instancia de bonslider
    function init(obj,optUser){
        ...
        var def = {
            ...
            next:false,
            prev:false,
            buttonWidth:15,     //Ancho de los botones
            speed:250,          //Velocidad con que se mueve el slider
            numObjects:1        //Cantidad de objetos que se mueven por vez
        };
