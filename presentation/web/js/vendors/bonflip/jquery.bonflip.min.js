/*maqinato (www.https://github.com/maparrar/maqinato) - Bonflip v.0.2
 *Jan 2013
...
;(function(e){e.fn.bonflip=function(t){var n=this;var r={color:null,time:800,trigger:null};var i=e.extend(r,t);n.each(function(){function r(e){var t=parseInt(e.attr("face"))+1;if(t>n){t=1}e.animate({transform:"skewY(-25deg) scaleX(.05)"},i.time/2,function(){e.children("li").hide();e.find("li:nth-child("+t+")").show();e.animate({transform:"scaleX(1) skewY(-180deg)"},i.time/2)});e.attr("face",t)}var t=e(this);if(!i.color){i.color=t.parent().css("background-color")}t.children("li").hide().first().show();t.attr("face",1);t.css("background",i.color);var n=t.children("li").length;t.click(function(){r(t)});i.trigger=t.closest(".box").find(".btn-flip");i.trigger.click(function(){r(t)})})}})(jQuery);